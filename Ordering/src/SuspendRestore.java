...
response.getWriter().println("<title></title><head><link rel='nofollow' type='text/css' href='styles.css'>");
response.getWriter().println("<link rel='nofollow' href='theme.css'>");
